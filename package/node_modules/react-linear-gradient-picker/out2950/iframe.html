    ...
    xhr.send(
      ...
      #docs-root[hidden] {
        display: none !important;
            ...
            window['FRAMEWORK_OPTIONS'] = {"fastRefresh":true};
            ...
            window['STORIES'] = [{"titlePrefix":"","directory":"./stories","files":"**/*.stories.@(js|tsx)","importPathMatcher":"^\\.[\\\\/](?:stories(?:\\/(?!\\.)(?:(?:(?!(?:^|\\/)\\.).)*?)\\/|\\/|$)(?!\\.)(?=.)[^/]*?\\.stories\\.(js|tsx))$"}];</script><script src="runtime~main.d271ae8c.iframe.bundle.js"></script><script src="758.b1a90a83.iframe.bundle.js"></script><script src="main.118b2fb1.iframe.bundle.js"></script></body></html>